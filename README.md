...
1. Створюємо папку redux, в ній файл store.js.
2. import { configureStore } from '@reduxjs/toolkit';
3. створюємо store
4. в index.js import { store } from './app/store' import { Provider } from
   'react-redux' і огортаємо все провайдером наше APP, в яке пропсом прокидаємо
   store={store}
